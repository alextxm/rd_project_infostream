...
namespace utils
{
    ...
    ///   <c>utils.GZipStream</c> can compress while writing, or decompress while
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly", MessageId = "GZip")]
	public class GZipStream : System.IO.Stream
    {
        ...
        /// </para>
        /// </remarks>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2201:DoNotRaiseReservedExceptionTypes"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1307:SpecifyStringComparison", MessageId = "System.String.EndsWith(System.String)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1307:SpecifyStringComparison", MessageId = "System.String.IndexOf(System.String)")]
        ...
        ///     {
        ///         using (Stream decompressor= new utils.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new utils.GZipStream(input, CompressionMode.Decompress, True)
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == utils.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == utils.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == utils.ZlibBaseStream.StreamMode.Undefined)
            {
